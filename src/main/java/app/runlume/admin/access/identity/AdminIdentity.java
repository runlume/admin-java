...
public interface AdminIdentity {
     ...
     * @return 账号视图列表
     */
    List<AdminUserView> listUsers(int offset, int limit, String keyword);
     ...
     */
    AdminUserView renameUser(UUID userId, String displayName);
     ...
     * @throws IdentityProblem 账号不存在
     */
    AdminUserView changeStatus(UUID userId, UserStatus status);
     ...
     */
    AdminUserView changeRoles(UUID userId, Set<String> roleCodes);
     ...
     * @return 本地账号视图
     */
    AdminUserView upsertPlatformUser(PlatformLaunchIdentity launch);
